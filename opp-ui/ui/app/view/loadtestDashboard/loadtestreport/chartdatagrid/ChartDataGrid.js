...
Ext.define('OppUI.view.loadtestDashboard.loadtestreport.chartdatagrid.ChartDataGrid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.chartdatagrid',

    requires: [
        'OppUI.view.loadtestDashboard.loadtestreport.chartdatagrid.ChartDataGridController',
        'OppUI.view.loadtestDashboard.loadtestreport.chartdatagrid.ChartDataGridModel'
    ],

    controller: 'chartdatagrid',
    viewModel: {
        type: 'chartdatagrid'
    },
    ...
    initComponent: function() {
        ...
        Ext.Ajax.request({
            url: '/loadsvc/v1/charts/aggregate/loadtests/' + this.getLoadTestId() + "?yaxis=" + this.getYAxis(),
            async: false,
            scope:this,
