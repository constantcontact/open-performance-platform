Ext.define('CCPerf.view.test.LoadListView' ,{
    extend: 'Ext.grid.Panel',
    alias: 'widget.testloadlist',
    title: 'Load Tests',
    id:'gridAllTestRunsLoad',
    store:'TestsLoadStore',
    columnLines: true,
    animCollapse: false,
    iconCls: 'icon-grid',
    margin: '0 0 20 0',
    ...
    initComponent: function() {
        ...
        this.selModel = Ext.create('Ext.selection.CheckboxModel', {
            checkOnly: true,
            // if the user is admin, allow multi-select so they can delete a bunch at a time
            mode: (this.getQueryVar('user') != 'admin') ? 'SINGLE' : 'MULTI'
        }),
