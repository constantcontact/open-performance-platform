...
--
-- Table structure for table `ci_load_test_job_type`
--

DROP TABLE IF EXISTS `ci_load_test_job_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ci_load_test_job_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2017-08-09 19:00:11
